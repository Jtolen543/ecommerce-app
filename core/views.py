...
from apps.models import UserLocation, Product, Category, ProductOrders, Order
...
from apps.shopping_cart import ShoppingCart
from ipware import get_client_ip
from apps.forms import *
from apps.helper import (location_exists, user_location_exists, update_user_location, parse_payments, product_packager,
                         randomize_carousel, calculate_tax, order_number_generator)
from apps.countries import reverse_country_dict
...
def register(request):
    if request.method == "POST":
        ...
        form = RegisterForm()
    return render(request,"core/auth/signup.html", {"form":form, "title":"Sign-Up", "current_year":current_year})


def tos(request):
    return render(request,"core/tos.html", {"current_year":current_year})
...
def signin(request):
    ...
    return render(request, 'core/auth/signin.html', context=context)
...
def reset_password(request):
    if request.method == "POST":
        ...
        form = ResetForm()
    return render(request,'core/auth/reset_password.html', {"form":form, "current_year":current_year, "title":"Reset"})
...
def set_password(request, uidb64, token):
    ...
    return render(request, "core/auth/set_password.html", context=context)
...
def profile_account(request):
    ...
    return render(request,"core/profile/account.html", context=context)
#
#
@login_required
def profile_location(request):
    ...
    return render(request,"core/profile/location.html", context=context)
...
def add_address(request):
    ...
    return render(request, "core/profile/address.html", context=context)
...
def profile_payment(request):
    ...
    return render(request, 'core/profile/payments.html', context=context)

@login_required
def add_payment(request):
    context = {'title': "Add Payment", 'current_year': current_year}
    return render(request, "core/profile/payments/add_payment.html", context=context)
...
def edit_payment(request, pm_id):
    ...
    return render(request, "core/profile/payments/edit_payment.html", context=context)
...
def profile_orders(request):
    ...
    return render(request, "core/profile/orders/orders.html", context=context)
...
def add_product(request):
    ...
    return render(request, 'core/admin/add_product.html', context=context)

@login_required
def delete_account(request):
    context = {"user": request.user, "title": "Delete Account"}
    return render(request, 'core/profile/delete_account.html', context=context)
...
def edit_product(request):
    ...
    return render(request, 'core/admin/edit_product.html', context=context)
...
def product(request, name):
    ...
    return render(request, 'core/product/page.html', context=context)
...
def shop_cart(request):
    ...
    return render(request, 'core/product/checkout.html', context=context)
...
def session_checkout(request):
    ...
    return render(request,"core/checkout/session_checkout.html", context=context)
...
def confirm_checkout(request):
    ...
    return render(request, "core/checkout/confirm_checkout.html", context=context)
...
def payment_success(request, pi_id):
    ...
    return render(request, "core/checkout/payment_success.html", context=context)
...
def review_order(request, order_num):
    ...
    return render(request, "core/checkout/order_summary.html", context=context)
...
def catalog(request, query=None):
    ...
    return render(request, "core/catalog/products.html", context=context)
